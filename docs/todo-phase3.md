...
| Member | Role | Focus |
|---|---|---|
| **Shreekrishna** | Model Owner | Training execution, model optimization, hyperparameter tuning |
...
**Guidance:**
- Run: `bash model/training/train_all_classifiers.sh data 20 8`
...
| 4.7 Hyperparam Optimization | Shreekrishna | 3 | 4.5 | Medium | ❌ |
| 4.8 Model Size/Speed Opt | Shreekrishna | 3 | 4.7 | Medium | ❌ |
