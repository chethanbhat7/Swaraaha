...
function HistoryPage({ setAnalyzedFile }: { setAnalyzedFile: React.Dispatch<React.SetStateAction<File | null>> }) {
  ...
  useEffect(() => {
    ...
    if (historyJson) {
      ...
      // Seed with some nice realistic mock records
      const dummyHistory: HistoryItem[] = [
        {
          id: "SWR-9204",
          date: "2026-07-28",
          time: "11:24 AM",
          name: "patient_reading_A.wav",
          size: "1.2 MB",
          duration: "00:34",
          mode: "Full Analysis",
          status: "Completed",
          results: {
            classification: {
              prolongation: { label: 1, confidence: 0.84 },
              block: { label: 0, confidence: 0.12 },
            ...
            localization: {
              regions: [
                { start: 1.2, end: 2.1, confidence: 0.84 },
                { start: 6.4, end: 7.8, confidence: 0.72 }
              ]
            }
          },
          generateReport: true,
        ...
        },
        {
          ...
          results: {
            classification: {
              prolongation: { label: 0, confidence: 0.15 },
              block: { label: 1, confidence: 0.89 },
              soundrep: { label: 0, confidence: 0.06 },
              wordrep: { label: 0, confidence: 0.04 },
              interjection: { label: 0, confidence: 0.22 }
            },
        ...
        },
        {
          ...
          date: "2026-07-25",
          time: "09:05 AM",
          name: "grandfather_passage_c.wav",
          size: "2.4 MB",
          duration: "01:12",
          mode: "Full Analysis",
          status: "Completed",
          results: {
            classification: {
              prolongation: { label: 0, confidence: 0.08 },
              block: { label: 0, confidence: 0.11 },
              soundrep: { label: 1, confidence: 0.92 },
              wordrep: { label: 1, confidence: 0.78 },
              interjection: { label: 0, confidence: 0.14 }
            },
            localization: {
              regions: [
                { start: 4.2, end: 5.5, confidence: 0.92 },
                { start: 12.1, end: 13.6, confidence: 0.78 }
              ]
            }
          },
          generateReport: true,
      ...
      localStorage.setItem('swaraaha_history', JSON.stringify(dummyHistory))
