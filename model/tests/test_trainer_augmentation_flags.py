...
from model.training import train_cnn_classifier
...
def test_cnn_classifier_parse_args_augmentation_default_on():
    args = train_cnn_classifier.parse_args([])
    assert args.augmentation is True


def test_cnn_classifier_parse_args_no_augmentation_flag():
    args = train_cnn_classifier.parse_args(["--no-augmentation"])
    assert args.augmentation is False
